...
<?php
$this->db->order_by('id_publikasi_ilmiah_dtps', 'ASC');
$this->db->limit(1);
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jenis Publikasi</label>
                      <div class="col-lg-9">
                            <input type="text" name="jenis_publikasi" id="jenis_publikasi" class="form-control" value="<?php echo $query->jenis_publikasi; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jumlah Judul</label>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote> TS-2</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_ts2" id="jumlah_judul_ts2" class="form-control" value="<?php echo $query->jumlah_judul_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_ts1" id="jumlah_judul_ts1" class="form-control" value="<?php echo $query->jumlah_judul_ts1; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_ts" id="jumlah_judul_ts" class="form-control" value="<?php echo $query->jumlah_judul_ts; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <a href="users/publikasi_ilmiah_dtps" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/publikasi_ilmiah_dtps') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("jenis_publikasi", jQuery("#jenis_publikasi").val());
            formData.append("jumlah_judul_ts", jQuery("#jumlah_judul_ts").val());
            formData.append("jumlah_judul_ts1", jQuery("#jumlah_judul_ts1").val());
            formData.append("jumlah_judul_ts2", jQuery("#jumlah_judul_ts2").val());
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/publikasi_ilmiah_dtps";
                //     }
                // });
