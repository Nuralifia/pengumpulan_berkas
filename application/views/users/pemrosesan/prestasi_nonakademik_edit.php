...
<?php
$this->db->order_by('id_prestasi_nonakademik', 'ASC');
$this->db->limit(1);
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control" value="<?php echo $query->nama_kegiatan; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Waktu Perolehan</label>
                      <div class="col-lg-9">
                            <input type="text" name="waktu_perolehan" id="waktu_perolehan" class="form-control" value="<?php echo $query->waktu_perolehan; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="prestasi" id="prestasi" class="form-control" value="<?php echo $query->prestasi; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="nrp" id="nrp" class="form-control" value="<?php echo $query->nrp; ?>" placeholder="">
                      </div>
                    </div>
                    ...
                    <hr>
                    <a href="users/prestasi_nonakademik" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/prestasi_nonakademik') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/prestasi_nonakademik";
                //     }
                // });
