...
<?php
$this->db->order_by('id_ipk_lulusan', 'ASC');
$this->db->limit(1);
?>
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/ipk_lulusan"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-12">Indeks Prestasi Kumulatif</label>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Min</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="indeks_min" id="indeks_min" class="form-control"  placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Rata-rata</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="indeks_rata" id="indeks_rata" class="form-control"  placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Maks</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="indeks_maks" id="indeks_maks" class="form-control"  placeholder="">
                      </div>
                    </div>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/ipk_lulusan') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("indeks_min", jQuery("#indeks_min").val());
            formData.append("indeks_rata", jQuery("#indeks_rata").val());
            formData.append("indeks_maks", jQuery("#indeks_maks").val());
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/ipk_lulusan/t";
                //     }
                // });
