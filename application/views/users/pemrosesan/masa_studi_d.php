    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h5 class="panel-title"><i class="icon-folder-download2"></i> Masa Studi Lulusan Pada Program Diploma Tiga</h5>
            ...
            <ul class="icons-list">
              <li><a data-action="collapse"></a></li>
                ...
                if ($user->row()->level == 'admin' or $user->row()->level == 's_admin') { ?>
                    <br>
                    <a href="users/masa_studi_d/t" class="btn btn-primary">+ <i class="icon-folder-download2"></i> Tambah Data</a>
                <?php
                } ?>
        </div>
        ...
        <table class="table datatable-basic" width="100%">
          <thead>
            <tr>
              ...
              <th colspan="5"><center>Jumlah Mahasiswa yang Lulus Pada</th>
          ...
          <tbody>
              <?php
              $no = 1;
              foreach ($masa_studi_d->result() as $baris) {
              ?>
                <tr>
                  <td><?php echo $no.'.'; ?></td>
                  ...
                  <td>
                    <a href="users/masa_studi_d/d/<?php echo $baris->id_masa_studi_d; ?>" class="btn btn-default btn-xs"><i class="icon-eye"></i></a>
                    
                    <?php
                    if ($user->row()->level == 's_admin' or $user->row()->level == 'admin' or $user->row()->level == 'timpjm' or $user->row()->level == 'pimpinan') { ?>
                    <a href="users/masa_studi_d/e/<?php echo $baris->id_masa_studi_d; ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>

                    <a href="users/masa_studi_d/h/<?php echo $baris->id_masa_studi_d; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda Yakin Ingin Menghapusnya ?')"><i class="icon-trash"></i></a>
