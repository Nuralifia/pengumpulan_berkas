...
<?php
$this->db->order_by('id_kerjasama_tridharma_penelitian', 'ASC');
$this->db->limit(1);
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/kerjasama_tridharma_penelitian') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/kerjasama_tridharma_penelitian/";
                //     }
                // });
