...
<?php
$this->db->order_by('id_kerjasama_tridharma_pengabdian', 'ASC');
$this->db->limit(1);
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="lembaga_mitra" id="lembaga_mitra" class="form-control" value="<?php echo $query->lembaga_mitra; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="judul_kegiatan_kerjasama" id="judul_kegiatan_kerjasama" class="form-control" value="<?php echo $query->judul_kegiatan_kerjasama; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Manfaat Bagi PS yang Diakreditasi</label>
                      <div class="col-lg-9">
                            <input type="text" name="manfaat" id="manfaat" class="form-control" value="<?php echo $query->manfaat; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Waktu dan Durasi</label>
                      <div class="col-lg-9">
                            <input type="text" name="waktu_dan_durasi" id="waktu_dan_durasi" class="form-control" value="<?php echo $query->waktu_dan_durasi; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Bukti Kerjasama</label>
                      <div class="col-lg-9">
                            <input type="text" name="bukti_kerjasama" id="bukti_kerjasama" class="form-control" value="<?php echo $query->bukti_kerjasama; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Tahun Berakhirnya Kerjasama</label>
                      <div class="col-lg-9">
                            <input type="text" name="tahun_berakhir" id="tahun_berakhir" class="form-control" value="<?php echo $query->tahun_berakhir; ?>" placeholder="">
                      </div>
                    </div>
                    ...
                    <hr>
                    <a href="users/kerjasama_tridharma_pengabdian" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/kerjasama_tridharma_pengabdian') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/kerjasama_tridharma_pengabdian";
                //     }
                // });
