        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Waktu Tunggu Pada Program Sarjana</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td class="col-lg-12"><b> 6 &le; WT &le; 18 Bulan </b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->mendapat_pekerjaan_618; ?></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b> WT > 18 Bulan </b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->mendapat_pekerjaan_18; ?></td>
                    </tr>
                  </table>
