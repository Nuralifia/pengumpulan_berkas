...
<?php
$this->db->order_by('id_luaran_pkm_lainnya_dtps', 'ASC');
$this->db->limit(1);
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/luaran_pkm_lainnya_dtps"  enctype="multipart/form-data" method="post">
                    ...
                    <hr>
                    <a href="users/luaran_pkm_lainnya_dtps" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/luaran_pkm_lainnya_dtps') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/luaran_pkm_lainnya_dtps/t";
                //     }
                // });
