...
<?php
$this->db->order_by('id_refrensi', 'ASC');
$this->db->limit(1);
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/refrensi"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jumlah Tanggapan Kepuasan Pengguna yang Terlacak</label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_tanggapan" id="jumlah_tanggapan" class="form-control" placeholder="">
                      </div>
                    </div>
                    ...
                    <hr>
                    <a href="users/refrensi" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/refrensi') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("jumlah_tanggapan", jQuery("#jumlah_tanggapan").val());
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/refrensi/t";
                //     }
                // });
