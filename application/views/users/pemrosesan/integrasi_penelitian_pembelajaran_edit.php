...
<?php
$this->db->order_by('id_integrasi_penelitian_pembelajaran', 'ASC');
$this->db->limit(1);
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Judul Penelitian/PkM</label>
                      <div class="col-lg-9">
                            <input type="text" name="judul" id="judul" class="form-control" value="<?php echo $query->judul; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Mata Kuliah</label>
                      <div class="col-lg-9">
                            <input type="text" name="matkul" id="matkul" class="form-control" value="<?php echo $query->matkul; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Bentuk Integrasi</label>
                      <div class="col-lg-9">
                            <input type="text" name="bentuk" id="bentuk" class="form-control" value="<?php echo $query->bentuk; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <a href="users/integrasi_penelitian_pembelajaran" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/integrasi_penelitian_pembelajaran') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("judul", jQuery("#judul").val());
            formData.append("nama_dosen", jQuery("#nama_dosen").val());
            formData.append("matkul", jQuery("#matkul").val());
            formData.append("bentuk", jQuery("#bentuk").val());
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/integrasi_penelitian_pembelajaran";
                //     }
                // });
