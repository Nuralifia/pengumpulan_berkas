        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/dosen_industri"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="nidk" id="nidk" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Perusahaan/Industri</label>
                      <div class="col-lg-9">
                            <input type="text" name="perusahaan" id="perusahaan" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Pendidikan Tertinggi</label>
                      <div class="col-lg-9">
                            <input type="text" name="pendidikan_tertinggi" id="pendidikan_tertinggi" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="sertifikat" id="sertifikat" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Mata Kuliah yang Diampu</label>
                      <div class="col-lg-9">
                            <input type="text" name="mata_kuliah" id="mata_kuliah" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Bobot Kredit (sks)</label>
                      <div class="col-lg-9">
                            <input type="text" name="bobot_kredit" id="bobot_kredit" class="form-control" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/dosen_industri/t";
                //     }
                // });
