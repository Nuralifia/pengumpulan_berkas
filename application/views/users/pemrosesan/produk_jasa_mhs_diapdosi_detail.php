        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Produk/Jasa DTPS yang Dihasilkan Mahasiswa yang Diapdosi oleh Industri/Masyarakat</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Nama Produk/Jasa :</b></td>
                    </tr>
                    <tr>
                      <td> <?php echo $query->produk_jasa; ?></td>
                    </tr>

                    <tr>
                      <td><b>Deskripsi Produk/Jasa :</b></td>
                    </tr>
                    <tr>
