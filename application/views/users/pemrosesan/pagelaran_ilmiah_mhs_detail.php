        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Pagelaran/Pameran/Presentasi/Publikasi Ilmiah Mahasiswa</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    <tr>
                      <td><b>Jenis Publikasi :</b></td>
                    </tr>
                      <tr>
                      <td> <?php echo $query->jenis_publikasi; ?></td>
                    </tr>
                       
                    <tr>
                      <td><b>Jumlah Judul :</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b>TS-2</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_judul_ts2; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_judul_ts1; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_judul_ts; ?></td>
                    </tr>
