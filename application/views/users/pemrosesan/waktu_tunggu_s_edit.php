              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="mendapat_pekerjaan_618" id="mendapat_pekerjaan_618" class="form-control" value="<?php echo $query->mendapat_pekerjaan_618; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group ">
                      <label class="control-label col-lg-3"><blockquote> WT > 18 Bulan</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="mendapat_pekerjaan_18" id="mendapat_pekerjaan_18" class="form-control" value="<?php echo $query->mendapat_pekerjaan_18; ?>" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/waktu_tunggu_s";
                //     }
                // });
