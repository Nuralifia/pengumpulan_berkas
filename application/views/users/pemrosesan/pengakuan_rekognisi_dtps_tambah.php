        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/pengakuan_rekognisi_dtps"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="rekognisi_bukti_pendukung" id="rekognisi_bukti_pendukung" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/pengakuan_rekognisi_dtps/t";
                //     }
                // });
