        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Integrasi Kegiatan Penelitian/PkM dalam Pembelajaran</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    <tr>
                      <td><b>Judul Penelitian/PkM :</b></td>
                    </tr>
                      <tr>
                    ...
                    <tr>
                      <td> <?php echo $query->matkul; ?></td>
                    </tr>

                    <tr>
                      <td><b>Bentuk Integrasi :</b></td>
                    </tr>
                    <tr>
                      <td> <?php echo $query->bentuk; ?></td>
                    </tr>
