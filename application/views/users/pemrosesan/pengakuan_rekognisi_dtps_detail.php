        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Pengakuan/Rekognisi DTPS</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Rekognisi Bukti Dan Pendukung :</b></td>
                    </tr>
                    <tr>
                      <td> <?php echo $query->rekognisi_bukti_pendukung; ?></td>
                    </tr>
