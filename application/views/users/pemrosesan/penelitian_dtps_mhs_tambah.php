        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/penelitian_dtps_mhs"  enctype="multipart/form-data" method="post">
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/penelitian_dtps_mhs/t";
                //     }
                // });
