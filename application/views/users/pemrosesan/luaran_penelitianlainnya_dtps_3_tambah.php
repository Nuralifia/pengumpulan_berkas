...
<?php
$this->db->order_by('id_luaran_penelitianlainnya_dtps_3', 'ASC');
$this->db->limit(1);
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/luaran_penelitianlainnya_dtps_3"  enctype="multipart/form-data" method="post">
                    
                    <div class="form-group">
                      <label class="control-label col-lg-3">Luaran Penelitian dan PkM</label>
                      <div class="col-lg-9">
                            <input type="text" name="luaran_penelitian" id="luaran_penelitian" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <a href="users/luaran_penelitianlainnya_dtps_3" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/luaran_penelitianlainnya_dtps_3') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/luaran_penelitianlainnya_dtps_3/t";
                //     }
                // });
