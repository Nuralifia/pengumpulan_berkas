        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Penelitian DTPS yang Menjadi Rujukan Tema Tesis/Disertasi</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Tema Penelitian Sesuai Readmap :</b></td>
                    </tr>
                    <tr>
                      <td> <?php echo $query->tema; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td><b>Judul Tesis/Disertasi :</b></td>
                    </tr>
                    <tr>
