...
<?php
$this->db->order_by('id_karya_dtps_disitasi', 'ASC');
$this->db->limit(1);
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="judul_artikel_disitasi" id="judul_artikel_disitasi" class="form-control" value="<?php echo $query->judul_artikel_disitasi; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jumlah Sitasi</label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_sitasi" id="jumlah_sitasi" class="form-control" value="<?php echo $query->jumlah_sitasi; ?>" placeholder="">
                      </div>
                    </div>
                    ...
                    <hr>
                    <a href="users/karya_dtps_disitasi" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/karya_dtps_disitasi') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/karya_dtps_disitasi";
                //     }
                // });
