    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h5 class="panel-title"><i class="icon-folder-download2"></i> Waktu Tunggu Pada Program Sarjana Terapan</h5>
          <h10 style="color:red">Diisi oleh pengusul dari Program Studi pada program Sarjana Terapan.</h10>
          <hr style="margin:0px;">
            ...
            <ul class="icons-list">
              <li><a data-action="collapse"></a></li>
                ...
                if ($user->row()->level == 'admin' or $user->row()->level == 's_admin') { ?>
                    <br>
                    <a href="users/waktu_tunggu_st/t" class="btn btn-primary">+ <i class="icon-folder-download2"></i> Tambah Data</a>
                <?php
                } ?>
        </div>
        ...
        <table class="table datatable-basic" width="100%">
          ...
          <tbody>
              <?php
              $no = 1;
              foreach ($waktu_tunggu_st->result() as $baris) {
              ?>
                <tr>
                  <td><?php echo $no.'.'; ?></td>
                  ...
                  <td>
                    <a href="users/waktu_tunggu_st/d/<?php echo $baris->id_waktu_tunggu_st; ?>" class="btn btn-default btn-xs"><i class="icon-eye"></i></a>
                    
                    <?php
                    if ($user->row()->level == 's_admin' or $user->row()->level == 'admin' or $user->row()->level == 'timpjm' or $user->row()->level == 'pimpinan') { ?>
                    <a href="users/waktu_tunggu_st/e/<?php echo $baris->id_waktu_tunggu_st; ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>

                    <a href="users/waktu_tunggu_st/h/<?php echo $baris->id_waktu_tunggu_st; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda Yakin Ingin Menghapusnya ?')"><i class="icon-trash"></i></a>
