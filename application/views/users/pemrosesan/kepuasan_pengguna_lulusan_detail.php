        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Kepuasan Pengguna Lulusan</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                   ...
                   <table width="100%" border=0>
                    <tr>
                      <td><b>Jenis Kepuasan :</b></td>
                    </tr>
                      <tr>
                      <td> <?php echo $query->jenis_kepuasan; ?></td>
                    </tr>
                       
                    <tr>
                      <td ><b>Tingkat Kepuasan Pengguna (%) :</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b>Sangat Baik</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->tingkat_kepuasan_sangat; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->tingkat_kepuasan_baik; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->tingkat_kepuasan_cukup; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->tingkat_kepuasan_kurang; ?></td>
                    </tr>
