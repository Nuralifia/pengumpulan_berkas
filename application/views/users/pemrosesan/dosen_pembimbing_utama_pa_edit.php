              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_diakreditasi_ts2" id="dibimbing_diakreditasi_ts2" class="form-control" value="<?php echo $query->dibimbing_diakreditasi_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_diakreditasi_ts1" id="dibimbing_diakreditasi_ts1" class="form-control" value="<?php echo $query->dibimbing_diakreditasi_ts1; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_diakreditasi_ts" id="dibimbing_diakreditasi_ts" class="form-control" value="<?php echo $query->dibimbing_diakreditasi_ts; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Rata-rata</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_diakreditasi_rata" id="dibimbing_diakreditasi_rata" class="form-control" value="<?php echo $query->dibimbing_diakreditasi_rata; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jumlah Mahasiswa yang Dibimbing</label>
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-2</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_pt_ts2" id="dibimbing_pt_ts2" class="form-control" value="<?php echo $query->dibimbing_pt_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_pt_ts1" id="dibimbing_pt_ts1" class="form-control" value="<?php echo $query->dibimbing_pt_ts1; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_pt_ts" id="dibimbing_pt_ts" class="form-control" value="<?php echo $query->dibimbing_pt_ts; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group col-lg-12">
                      <label class="control-label col-lg-3"><blockquote>Rata-rata</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="dibimbing_pt_rata" id="dibimbing_pt_rata" class="form-control" value="<?php echo $query->dibimbing_pt_rata; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Rata-rata JUmlah Bimbingan di Semua Program/Semester</label>
                      <div class="col-lg-9">
                            <input type="text" name="ratarata_jumlah_bimbingan" id="ratarata_jumlah_bimbingan" class="form-control" value="<?php echo $query->ratarata_jumlah_bimbingan; ?>" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/dosen_pembimbing_utama_pa";
                //     }
                // });
