        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Penelitian DTPS</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Jumlah Judul Penelitian :</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b>TS-2 </b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_judul_penelitian_ts2; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_judul_penelitian_ts1; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_judul_penelitian_ts; ?></td>
                    </tr>
