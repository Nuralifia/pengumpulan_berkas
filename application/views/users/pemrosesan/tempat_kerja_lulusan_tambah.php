        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/tempat_kerja_lulusan"  enctype="multipart/form-data" method="post">
                    
                    <div class="form-group">
                      <label class="control-label col-lg-3">Tahun Lulusan</label>
                      <div class="col-lg-9">
                            <input type="text" name="tahun_lulusan" id="tahun_lulusan" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="bekerja_lokal" id="bekerja_lokal" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Nasional/Berwirausaha Berbadan Hukum</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="bekerja_nasional" id="bekerja_nasional" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Multinasional/Internasional</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="bekerja_multi" id="bekerja_multi" class="form-control" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/tempat_kerja_lulusan/t";
                //     }
                // });
