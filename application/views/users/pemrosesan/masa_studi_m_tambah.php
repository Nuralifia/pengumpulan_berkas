...
<?php
$this->db->order_by('id_masa_studi_m', 'ASC');
$this->db->limit(1);
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/masa_studi_m"  enctype="multipart/form-data" method="post">
                    ...
                    <hr>
                    <a href="users/masa_studi_m" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/masa_studi_m') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/masa_studi_m/t";
                //     }
                // });
