...
<?php
$this->db->order_by('id_penelitian_dtps', 'ASC');
$this->db->limit(1);
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="sumber_pembiayaan" id="sumber_pembiayaan" class="form-control" value="<?php echo $query->sumber_pembiayaan; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jumlah Judul Penelitian</label>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-2</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_penelitian_ts2" id="jumlah_judul_penelitian_ts2" class="form-control" value="<?php echo $query->jumlah_judul_penelitian_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_penelitian_ts1" id="jumlah_judul_penelitian_ts1" class="form-control" value="<?php echo $query->jumlah_judul_penelitian_ts1; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_penelitian_ts" id="jumlah_judul_penelitian_ts" class="form-control" value="<?php echo $query->jumlah_judul_penelitian_ts; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <a href="users/penelitian_dtps" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/penelitian_dtps') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("jumlah_judul_penelitian_ts", jQuery("#jumlah_judul_penelitian_ts").val());
            formData.append("jumlah_judul_penelitian_ts1", jQuery("#jumlah_judul_penelitian_ts1").val());
            formData.append("jumlah_judul_penelitian_ts2", jQuery("#jumlah_judul_penelitian_ts2").val());
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/penelitian_dtps";
                //     }
                // });
