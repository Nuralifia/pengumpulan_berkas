...
<?php
$this->db->order_by('id_penelitian_dtps_tesis', 'ASC');
$this->db->limit(1);
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Tema Penelitian Sesuai Readmap</label>
                      <div class="col-lg-9">
                            <input type="text" name="tema" id="tema" class="form-control" value="<?php echo $query->tema; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Judul Tesis/Disertasi</label>
                      <div class="col-lg-9">
                    ...
                    <hr>
                    <a href="users/penelitian_dtps_tesis" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/penelitian_dtps_tesis') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("sending", function(data, xhr, formData) {
            ...
            formData.append("tema", jQuery("#tema").val());
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/penelitian_dtps_tesis";
                //     }
                // });
