        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/kurikulum"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="kode_matkul" id="kode_matkul" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Nama Mata Kuliah</label>
                      <div class="col-lg-9">
                            <input type="text" name="nama_matkul" id="nama_matkul" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Mata Kuliah Kom-petensi</label>
                      <div class="col-lg-9">
                            <input type="text" name="matkul_kom" id="matkul_kom" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="bobot_kuliah" id="bobot_kuliah" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Seminar</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="bobot_seminar" id="bobot_seminar" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Praktikum/ Praktik/Praktik Lapangan</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="bobot_praktikum" id="bobot_praktikum" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Konversi Kredit ke jam</label>
                      <div class="col-lg-9">
                            <input type="text" name="konversi" id="konversi" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="capaian_sikap" id="capaian_sikap" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>  Pengetahuan</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="capaian_pengetahuan" id="capaian_pengetahuan" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>  Keteretampilan Umum</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="capaian_umum" id="capaian_umum" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>  Keteretampilan Khusus</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="capaian_khusus" id="capaian_khusus" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/kurikulum/t";
                //     }
                // });
