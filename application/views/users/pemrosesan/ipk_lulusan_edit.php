              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="indeks_min" id="indeks_min" class="form-control" value="<?php echo $query->indeks_min; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Rata-rata</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="indeks_rata" id="indeks_rata" class="form-control" value="<?php echo $query->indeks_rata; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Maks</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="indeks_maks" id="indeks_maks" class="form-control" value="<?php echo $query->indeks_maks; ?>" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/ipk_lulusan";
                //     }
                // });
