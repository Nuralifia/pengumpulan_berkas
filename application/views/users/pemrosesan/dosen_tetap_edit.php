              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="pendidikan_magister" id="pendidikan_magister" class="form-control" value="<?php echo $query->pendidikan_magister; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Doktor/Doktor Terapan/Spesialis</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="pendidikan_doktor" id="pendidikan_doktor" class="form-control" value="<?php echo $query->pendidikan_doktor; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="kesesuaian_kompetensi" id="kesesuaian_kompetensi" class="form-control" value="<?php echo $query->kesesuaian_kompetensi; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="mata_kuliah_akreditasi" id="mata_kuliah_akreditasi" class="form-control" value="<?php echo $query->mata_kuliah_akreditasi; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="mata_kuliah_lain" id="mata_kuliah_lain" class="form-control" value="<?php echo $query->mata_kuliah_lain; ?>" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/dosen_tetap";
                //     }
                // });
