        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Ilmiah DTPS yang Disitasi</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Judul Artikel yang Disitasi (Jurnal, Volume, Tahun, Nomor, Halaman) :</b></td>
                    </tr>
                    <tr>
                      <td> <?php echo $query->judul_artikel_disitasi; ?></td>
                    </tr>

                    <tr>
                      <td><b>Jumlah Sitasi :</b></td>
                    </tr>
                    <tr>
                      <td> <?php echo $query->jumlah_sitasi; ?></td>
                    </tr>
                  </table>
