        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/penelitian_dtps"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_penelitian_ts2" id="jumlah_judul_penelitian_ts2" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_penelitian_ts1" id="jumlah_judul_penelitian_ts1" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_penelitian_ts" id="jumlah_judul_penelitian_ts" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/penelitian_dtps/t";
                //     }
                // });
