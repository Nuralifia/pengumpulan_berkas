              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_tingkat_rendah" id="jumlah_tingkat_rendah" class="form-control" value="<?php echo $query->jumlah_tingkat_rendah; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group ">
                      <label class="control-label col-lg-3"><blockquote>Sedang</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_tingkat_sedang" id="jumlah_tingkat_sedang" class="form-control" value="<?php echo $query->jumlah_tingkat_sedang; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group ">
                      <label class="control-label col-lg-3"><blockquote>Tinggi</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_tingkat_tinggi" id="jumlah_tingkat_tinggi" class="form-control" value="<?php echo $query->jumlah_tingkat_tinggi; ?>" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/kesesuaian_bidang_kerja";
                //     }
                // });
