        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Refrensi Untuk Tabel Kepuasan Pengguna Lulusan</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Jumlah Tanggapan Kepuasan Pengguna yang Terlacak :</b></td>
                    </tr>
                    <tr>
                      <td> <?php echo $query->jumlah_tanggapan; ?></td>
                    </tr>
                  </table>
