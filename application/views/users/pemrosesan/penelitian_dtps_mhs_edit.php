...
<?php
$this->db->order_by('id_penelitian_dtps_mhs', 'ASC');
$this->db->limit(1);
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Judul Kegiatan</label>
                      <div class="col-lg-9">
                    ...
                    <hr>
                    <a href="users/penelitian_dtps_mhs" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/penelitian_dtps_mhs') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/penelitian_dtps_mhs";
                //     }
                // });
