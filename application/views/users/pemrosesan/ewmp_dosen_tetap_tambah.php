        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/ewmp_dosen_tetap"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="dtps" id="dtps" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="ekuivalen_pendidikan_akreditasi" id="ekuivalen_pendidikan_akreditasi" class="form-control"  placeholder="">
                      </div>
                    </div>
                    <div class="form-group ">
                      <label class="control-label col-lg-3"><blockquote>PS lain di dalam PT</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="ekuivalen_pendidikan_dalampt" id="ekuivalen_pendidikan_dalampt" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>PS lain di luar PT</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="ekuivalen_pendidikan_luarpt" id="ekuivalen_pendidikan_luarpt" class="form-control"  placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-12">Ekuivalen Waktu Mengajar Penuh (EWMP) pada saat TS dalam satuan kredit semester (sks)</label>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="penelitian" id="penelitian" class="form-control"  placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>PkM</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="pkm" id="pkm" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Tugas Tambahan dan/atau Penunjang</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="tugas" id="tugas" class="form-control"  placeholder="">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_sks" id="jumlah_sks" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Rata-Rata Per Semester (sks)</label>
                      <div class="col-lg-9">
                            <input type="text" name="rata_persemester" id="rata_persemester" class="form-control"  placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/ewmp_dosen_tetap/t";
                //     }
                // });
