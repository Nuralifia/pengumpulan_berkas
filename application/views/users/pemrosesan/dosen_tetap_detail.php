        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Dosen Tetap Perguruan Tinggi</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td class="col-lg-12"><b>Magister/Magister Terapan/Spesialis</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->pendidikan_magister; ?></td>
                    </tr>

                    <tr>
                      <td class="col-lg-12"><b>Doktor/Doktor Terapan/Spesialis</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->pendidikan_doktor; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td><b>Kesesuaian dengan Kompetensi inti IPS :</b></td>
                      </tr>
                      <tr>
                      <td> <?php echo $query->kesesuaian_kompetensi; ?></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <tr>
                      <td> <?php echo $query->mata_kuliah_akreditasi; ?></td>
                    </tr>
                    ...
                    <tr>
                      <td><b>Mata Kuliah yang Diampu pada PS Lain :</b></td>
                      </tr>
                      <tr>
                      <td> <?php echo $query->mata_kuliah_lain; ?></td>
                    </tr>
                  </table>
