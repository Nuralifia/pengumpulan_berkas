              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="jenis_pengguna" id="jenis_pengguna" class="form-control" value="<?php echo $query->jenis_pengguna; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="unit_pengelola_ts2" id="unit_pengelola_ts2" class="form-control" value="<?php echo $query->unit_pengelola_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="unit_pengelola_ts1" id="unit_pengelola_ts1" class="form-control" value="<?php echo $query->unit_pengelola_ts1; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote> TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="unit_pengelola_ts" id="unit_pengelola_ts" class="form-control" value="<?php echo $query->unit_pengelola_ts; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Rata-rata</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="unit_pengelola_rata" id="unit_pengelola_rata" class="form-control" value="<?php echo $query->unit_pengelola_rata; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Program Studi (Rupiah)</label>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-2</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="program_studi_ts2" id="program_studi_ts2" class="form-control" value="<?php echo $query->program_studi_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="program_studi_ts1" id="program_studi_ts1" class="form-control" value="<?php echo $query->program_studi_ts1; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="program_studi_ts" id="program_studi_ts" class="form-control" value="<?php echo $query->program_studi_ts; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Rata-rata</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="program_studi_rata" id="program_studi_rata" class="form-control" value="<?php echo $query->program_studi_rata; ?>" placeholder="">
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/penggunaan_dana";
                //     }
                // });
