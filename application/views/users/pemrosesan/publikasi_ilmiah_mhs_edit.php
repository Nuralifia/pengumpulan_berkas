...
<?php
$this->db->order_by('id_publikasi_ilmiah_mhs', 'ASC');
$this->db->limit(1);
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <hr>
                    <a href="users/publikasi_ilmiah_mhs" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/publikasi_ilmiah_mhs') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/publikasi_ilmiah_mhs";
                //     }
                // });
