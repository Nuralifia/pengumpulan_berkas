...
<?php
$this->db->order_by('id_masa_studi_s', 'ASC');
$this->db->limit(1);
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/masa_studi_s"  enctype="multipart/form-data" method="post">
                    
                    <div class="form-group">
                      <label class="control-label col-lg-3">Tahun Masuk</label>
                      <div class="col-lg-9">
                            <input type="text" name="tahun_masuk" id="tahun_masuk" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jumlah Mahasiswa Diterima</label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_diterima" id="jumlah_mhs_diterima" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-12">Jumlah Mahasiswa Lulus Pada</label>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Akhir TS-6</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_lulus_ts6" id="jumlah_mhs_lulus_ts6" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Akhir TS-5</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_lulus_ts5" id="jumlah_mhs_lulus_ts5" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Akhir TS-4</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_lulus_ts4" id="jumlah_mhs_lulus_ts4" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Akhir TS-3</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_lulus_ts3" id="jumlah_mhs_lulus_ts3" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Akhir TS-2</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_lulus_ts2" id="jumlah_mhs_lulus_ts2" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Akhir TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_lulus_ts1" id="jumlah_mhs_lulus_ts1" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>Akhir TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_mhs_lulus_ts" id="jumlah_mhs_lulus_ts" class="form-control" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="rata_studi" id="rata_studi" class="form-control" placeholder="">
                      </div>
                    </div>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/masa_studi_s') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/masa_studi_s/t";
                //     }
                // });
