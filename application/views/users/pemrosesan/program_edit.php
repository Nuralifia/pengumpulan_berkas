              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="nama_program" id="nama_program" class="form-control" value="<?php echo $query->nama_program; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Jenis Program</label>
                      <div class="col-lg-9">
                            <input type="text" name="jenis_program" id="jenis_program" class="form-control" value="<?php echo $query->jenis_program; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Peringkat Akreditasi PS</label>
                      <div class="col-lg-9">
                            <input type="text" name="peringkat" id="peringkat" class="form-control" value="<?php echo $query->peringkat; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Nomor SK BAN-PT</label>
                      <div class="col-lg-9">
                            <input type="text" name="no_sk" id="no_sk" class="form-control" value="<?php echo $query->no_sk; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Tanggal Kadaluarsa</label>
                      <div class="col-lg-9">
                            <input type="text" name="tgl_kadaluarsa" id="tgl_kadaluarsa" class="form-control" value="<?php echo $query->tgl_kadaluarsa; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Nama Unit Pengelola</label>
                      <div class="col-lg-9">
                            <input type="text" name="nama_unit" id="nama_unit" class="form-control" value="<?php echo $query->nama_unit; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Nama Perguruan Tinggi</label>
                      <div class="col-lg-9">
                            <input type="text" name="nama_perguruan" id="nama_perguruan" class="form-control" value="<?php echo $query->nama_perguruan; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Alamat</label>
                      <div class="col-lg-9">
                            <input type="text" name="alamat" id="alamat" class="form-control" value="<?php echo $query->alamat; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Nomor Telepon</label>
                      <div class="col-lg-9">
                            <input type="text" name="no_tlp" id="no_tlp" class="form-control" value="<?php echo $query->no_tlp; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">E-mail</label>
                      <div class="col-lg-9">
                            <input type="text" name="email" id="email" class="form-control" value="<?php echo $query->email; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Website</label>
                      <div class="col-lg-9">
                            <input type="text" name="website" id="website" class="form-control" value="<?php echo $query->website; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">TS *)</label>
                      <div class="col-lg-9">
                            <input type="text" name="ts" id="ts" class="form-control" value="<?php echo $query->ts; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Nama Pengusul</label>
                      <div class="col-lg-9">
                            <input type="text" name="nama_pengusul" id="nama_pengusul" class="form-control" value="<?php echo $query->nama_pengusul; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/program";
                //     }
                // });
