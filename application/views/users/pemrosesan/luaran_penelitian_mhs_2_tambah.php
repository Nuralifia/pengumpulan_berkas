...
<?php
$this->db->order_by('id_luaran_penelitian_mhs_2', 'ASC');
$this->db->limit(1);
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <div class="msg"></div>
                <form class="form-horizontal" action="users/luaran_penelitian_mhs_2"  enctype="multipart/form-data" method="post">
                    ...
                    <hr>
                    <a href="users/luaran_penelitian_mhs_2" class="btn btn-default"><< Kembali</a>
...
Dropzone.options.myDropzone = {
  ...
  url: "<?php echo base_url('users/luaran_penelitian_mhs_2') ?>",
  paramName:"userfile",
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/luaran_penelitian_mhs_2/t";
                //     }
                // });
