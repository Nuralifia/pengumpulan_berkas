        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Daftar Program studi di Unit Pengelola Program Studi (UPPS)</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Akreditasi Program Studi :</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b>Status/Peringkat</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->status; ?></td>
                    </tr>

                    <tr>
                      <td class="col-lg-12"><b>No. dan Tgl.SK</b></td>
                     </tr>
                     <tr>
                      <td class="col-lg-12"> <?php echo $query->no; ?></td>
                    </tr>

                    <tr>
                      <td class="col-lg-12"><b>Tgl. Kadaluarsa</b></td>
                      </tr>
                      <tr>
                      <td class="col-lg-12"> <?php echo $query->tanggal; ?></td>
                    </tr>

                    <tr>
                      <td><b>Jumlah Mahasiswa Saat TS :</b></td>
                      </tr>
                      <tr>
