                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <div class="input-group">
                          ...
                          <input type="text" name="tanggal" class="form-control daterange-single" id="tanggal" value="<?php echo $query->tanggal; ?>" maxlength="10" required placeholder="Masukkan Tanggal">
                        </div>
                      </div>
                    </div>
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/saran";
                //     }
                // });
