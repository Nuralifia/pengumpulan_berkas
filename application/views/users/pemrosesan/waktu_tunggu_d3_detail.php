        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Waktu Tunggu Pada Program Diploma Tiga</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Jumlah Lulusan Yang Dipesan Sebelum Lulus :</b></td>
                    </tr>
                      <tr>
                      <td> <?php echo $query->jumlah_dipesan; ?></td>
                    </tr>
                       
                    <tr>
                      <td ><b>Jumlah Lulusan Terlacak Dengan Waktu Tunggu Mendapatkan Pekerjaan :</b></td>
                      <tr>
                      <td class="col-lg-12"><b>WT < 3 Bulan </b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->mendapat_pekerjaan_3; ?></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b> 3 &le; WT &le; 6 Bulan</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->mendapat_pekerjaan_36; ?></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b> WT > 6 Bulan </b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->mendapat_pekerjaan_6; ?></td>
                    </tr>
                  </table>
