        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-folder-download2"></i> Detail Kesesuaian Bidang Kerja Lulusan</legend>
                <?php
                ...
                <form class="form-horizontal" action=""  enctype="multipart/form-data" method="post">
                  ...
                  <table width="100%" border=0>
                    ...
                    <tr>
                      <td><b>Jumlah Lulusan Terlacak Dengan Tingkat Kesesuaian Bidang Kerja :</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"><b> Rendah</b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_tingkat_rendah; ?></td>
                    </tr>

                    <tr>
                      <td class="col-lg-12"><b>Sedang </b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_tingkat_sedang; ?></td>
                    </tr>

                    <tr>
                      <td class="col-lg-12"><b>Tinggi </b></td>
                    </tr>
                    <tr>
                      <td class="col-lg-12"> <?php echo $query->jumlah_tingkat_tinggi; ?></td>
                    </tr>
                  </table>
