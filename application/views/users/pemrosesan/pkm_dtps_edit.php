              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_pkm_ts2" id="jumlah_judul_pkm_ts2" class="form-control" value="<?php echo $query->jumlah_judul_pkm_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS-1</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_pkm_ts1" id="jumlah_judul_pkm_ts1" class="form-control" value="<?php echo $query->jumlah_judul_pkm_ts1; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3"><blockquote>TS</blockquote></label>
                      <div class="col-lg-9">
                            <input type="text" name="jumlah_judul_pkm_ts" id="jumlah_judul_pkm_ts" class="form-control" value="<?php echo $query->jumlah_judul_pkm_ts2; ?>" placeholder="">
                      </div>
                    </div>
                    <div class="form-group">
  ...
  init: function() {
    ...
    this.on("success", function (file, response) {
      ...
      $(".cari_ns").val('').trigger('change');
                            ...
                            window.location="<?php echo base_url(); ?>users/pkm_dtps";
                //     }
                // });
